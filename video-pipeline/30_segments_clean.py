...
def segment_raw_handle(
    ...
    if command == "m":
        ...
        print("edited")
        return segment_raw_handle(segment_prev, segment, segment_save)
    elif command == "k":
        print("kept")
...
def main(input_file, output_file, non_interactive):
...
if __name__ == "__main__":
    ...
    main(args.infile, args.outfile, args.non_interactive)
